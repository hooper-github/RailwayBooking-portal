...
?>
<hr>
<marquee behavior="alternate" direction="right"  scrollamount="5" onmouseover="stop()" onmouseout="start()">
...
<li><a href='iit.html'  title="......."><span>Cancellations/Refund</span></a></li> 
...
<td bgcolor="white">
<font size="5" color="black" face="cambria"><center><b>AVAILABLE TRAINS</b><br>
<?php
session_start();
$x=$_POST['x'];
$y=$_POST['y'];
...
echo "<td><b> <font size=3.5>&nbsp &nbsp &nbsp&nbsp &nbsp  FROM &nbsp &nbsp &nbsp &nbsp &nbsp  TO &nbsp &nbsp &nbsp &nbsp    NUMBER OF TICKETS </td>";
echo "</tr>";
...
<input type='text' name='x' size='6' value=$x>
<input type='text' name='y' size='6' value=$y>
